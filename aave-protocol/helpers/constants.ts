...
export const MOCK_CHAINLINK_AGGREGATORS_PRICES = {
  ...
  ALEX: oneEther.multipliedBy('0.001151').toFixed(),
  SERG: oneEther.multipliedBy('0.001151').toFixed(),
  ROBERT: oneEther.multipliedBy('0.001151').toFixed(),
  NEHEMIA: oneEther.multipliedBy('0.001151').toFixed(),
  RICHARD: oneEther.multipliedBy('0.001151').toFixed(),
  LUKE: oneEther.multipliedBy('0.001151').toFixed(),
  PEDRO: oneEther.multipliedBy('0.001151').toFixed(),
  GEOFF: oneEther.multipliedBy('0.001151').toFixed(),
  ...
  WWAT: oneEther.multipliedBy('0.003620948469').toFixed(),
...
export const chainlinkAggregatorProxy = {
  ...
  goerli: '0xcE9cB71Cb9306Fdb3E790DB78fB68cA9e747C58C',
  waterfall: '0xB4823B3f623d89464f879B44dB4e29469aD434ef',
