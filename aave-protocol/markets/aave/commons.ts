...
export const CommonsConfig: ICommonConfiguration = {
  ...
  PoolAdmin: {
    ...
    [eEthereumNetwork.waterfall]: undefined,
  ...
  ProviderRegistryOwner: {
    ...
    [eEthereumNetwork.goerli]: '0xa7e558Cc6efA1c41270eF4Aa227b3dd6B4a3951E',
    [eEthereumNetwork.waterfall]: '0xa7062a2bd7270740f1d15ab70b3dee189a87b6de',
  },
  LendingRateOracle: {
    [eEthereumNetwork.coverage]: '',
    [eEthereumNetwork.hardhat]: '',
    ...
    [eEthereumNetwork.waterfall]: ZERO_ADDRESS,
  },
  ...
  TokenDistributor: {
    ...
    [eEthereumNetwork.goerli]: '0x97a81A19c2ae97E6676dFf2f1c93DCf777f28656',
    [eEthereumNetwork.waterfall]: '0x8FC514969b334ed5E1E83fDef7fFe04B59CA7C05',
  },
  AaveOracle: {
    [eEthereumNetwork.coverage]: '',
    [eEthereumNetwork.hardhat]: '',
  ...
  FallbackOracle: {
    ...
    [eEthereumNetwork.goerli]: '0x88d2A65fBFb27D3Fa427334ec2E7a2854C583676',
    [eEthereumNetwork.waterfall]: '0xb8eeb7f1f01Bf7c4ebC651e2Ee41336Ec08DDF2c',
  },
  ChainlinkAggregator: {
    [eEthereumNetwork.coverage]: {},
    [eEthereumNetwork.hardhat]: {},
    ...
    [eEthereumNetwork.goerli]: {
      // AAVE: '0x5Bf190032319a6CA299a9d8E1735A0F1B786C206',
      // BAT: '0x534afd348cFD029f5145c4534a64e9b3E1323ec3',
      BUSD: '0xD6654a4890C24F268360040a816CA872E1D644Ec',
      AAVE: ZERO_ADDRESS,
      BAT: ZERO_ADDRESS,
      DAI: ZERO_ADDRESS,
      ENJ: ZERO_ADDRESS,
      KNC: ZERO_ADDRESS,
      LINK: ZERO_ADDRESS,
      MANA: '0x4360F0fe34d1D15FAC2C686723FA8E2905F4545D',
      MKR: ZERO_ADDRESS,
      REN: ZERO_ADDRESS,
      SNX: ZERO_ADDRESS,
      SUSD: ZERO_ADDRESS,
      ...
      USDT: ZERO_ADDRESS,
      WBTC: ZERO_ADDRESS,
      YFI: '0x4C912aAfED80D65263246691811f42D4c45BdFa6',
      ZRX: ZERO_ADDRESS,
      USD: '0xcE9cB71Cb9306Fdb3E790DB78fB68cA9e747C58C',
      xSUSHI: ZERO_ADDRESS,
    },
    [eEthereumNetwork.waterfall]: {
      ALEX: '0x303BC169B96C3cbBF6ad4CE12fD392f740cE1Ac3',
      SERG: '0x644cF64F081fc4907e253C83De68B7107daE1d78',
      NEHEMIA: '0xDEfb8d2624CD31AC109ca3aF1a9500028EA9f95C',
      RICHARD: '0x98B3EF6c1a78a95136D56C5aC7521E5a2D10899F',
      LUKE: '0x837BA9bC39268426ABbF29Cc38B35382410b3F56',
      PEDRO: '0x3D2DbeA93814b81C66250b2128Cd47568Bc68Ec5',
      ROBERT: '0x812DFF4a911e3D974A23419cC7BD2A6bfD565346',
      GEOFF: '0x974be5F794400e863fc11fa88256CD1b223a669B',
      AAVE: ZERO_ADDRESS,
      BAT: ZERO_ADDRESS,
      BUSD: ZERO_ADDRESS,
      DAI: ZERO_ADDRESS,
  ...
  WETH: {
    ...
    [eEthereumNetwork.goerli]: '',
    [eEthereumNetwork.waterfall]: '0x219ed1326b82c468f825cbD727dbaf66810a619C',
  },
  WrappedNativeToken: {
    [eEthereumNetwork.coverage]: '', // deployed in local evm
    [eEthereumNetwork.hardhat]: '', // deployed in local evm
    ...
    [eEthereumNetwork.waterfall]: '0x219ed1326b82c468f825cbD727dbaf66810a619C', //WWAT
  },
  ReserveFactorTreasuryAddress: {
    ...
    [eEthereumNetwork.goerli]: '0x4e2D7ae92cB821f183e59A831eD305D4dDde98d5',
    [eEthereumNetwork.waterfall]: '0xe9C2Ffa57589e95bD29DDf932239f9F58666b26e',
  },
