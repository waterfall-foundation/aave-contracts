...
export const AaveConfig: IAaveConfiguration = {
  ...
  ReservesConfig: {
    ...
    ALEX: strategyAlex,
    SERG: strategySerg,
    ROBERT: strategyROBERT,
    WWAT: strategyWWAT,
    NEHEMIA: strategyNEHEMIA,
    RICHARD: strategyRICHARD,
    LUKE: strategyLUKE,
    PEDRO: strategyPEDRO,
    GEOFF: strategyGEOFF,
  },
